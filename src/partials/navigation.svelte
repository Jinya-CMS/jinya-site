...
<nav class="jinya-nav jinya-nav--desktop" class:jinya-nav--inverse={inverse}>
  ...
  <div class="jinya-nav__right">
    ...
    <a class="jinya-nav__link" class:jinya-nav__link--inverse={inverse} href="https://plan.jinya.de" target="_blank">
      Jinya Plan
    </a>
    <a class="jinya-nav__link" class:jinya-nav__link--inverse={inverse} href={resolve('/contact')}>Contact</a>
    <a class="jinya-nav__link" class:jinya-nav__link--inverse={inverse} href="https://github.com/Jinya-CMS"
       target="_blank">
      <Github />
    </a>
  </div>
...
<nav class="jinya-nav--mobile" class:jinya-nav--mobile-open={navToggled}>
  ...
  <a class="jinya-nav__link jinya-nav__link--inverse" href="https://plan.jinya.de" target="_blank">
    Jinya Plan
  </a>
  <a class="jinya-nav__link jinya-nav__link--inverse" href={resolve('/contact')} on:click={hideNav}>Contact</a>
  <a class="jinya-nav__link jinya-nav__link--inverse" href="https://github.com/Jinya-CMS" on:click={hideNav}
     target="_blank"
  >Github
  </a>
</nav>
