<script>
  ...
  titleStore.set('Privacy Policy');
</script>

<Article title='Privacy Policy for jinya.de'>
  <p>At Jinya CMS, accessible from jinya.de, one of our main priorities is the privacy of our visitors. This Privacy
    Policy document contains types of information that is collected and recorded by Jinya CMS and how we use it.</p>

  <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact
    us. Our Privacy Policy was generated with the help of <a href='https://www.gdprprivacypolicy.net/'>GDPR Privacy
      Policy Generator</a></p>

  <h2 class='jinya-header'>General Data Protection Regulation (GDPR)</h2>
  <p>We are a Data Controller of your information.</p>

  <p>Imanuel Ulbricht legal basis for collecting and using the personal information described in this Privacy Policy
    depends on the Personal Information we collect and the specific context in which we collect the information:</p>
  <ul>
    <li>Imanuel Ulbricht needs to perform a contract with you</li>
    <li>You have given Imanuel Ulbricht permission to do so</li>
    <li>Processing your personal information is in Imanuel Ulbricht legitimate interests</li>
    <li>Imanuel Ulbricht needs to comply with the law</li>
  </ul>

  <p>Imanuel Ulbricht will retain your personal information only for as long as is necessary for the purposes set out in
  ...
  <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. If you wish to
  ...
  <p>Jinya CMS follows a standard procedure of using log files. These files log visitors when they visit websites. All
  ...
  <h2 class='jinya-header'>Privacy Policies</h2>

  <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Jinya CMS.</p>

  <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
    their respective advertisements and links that appear on Jinya CMS, which are sent directly to users' browser. They
  ...
  <p>Note that Jinya CMS has no access to or control over these cookies that are used by third-party advertisers.</p>

  <h2 class='jinya-header'>Third Party Privacy Policies</h2>

  <p>Jinya CMS's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
  ...
  <h2 class='jinya-header'>Children's Information</h2>
  ...
  <p>Jinya CMS does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
